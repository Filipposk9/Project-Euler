...
public class Problem11 {
	...
	private static int[][] stringToArray(String s){
		...
		for (int i = 0; i<20; i++){
			for (int j = 0; j<20; j++){
				array[i][j] =Integer.parseInt(s.substring(count, count +2));
				count = count + 3;
			}
		}
	...
	private static void rightMax(int[][] array){
	...
	private static void downMax(int[][] array){
	...
	private static void diagonalDownMax(int[][] array){
	...
	private static void diagonalUpMax(int[][] array){
	...
	public static void main(String[] args) {
		...
		numbers = stringToArray(s);
		
		rightMax(numbers);
		downMax(numbers);
		diagonalDownMax(numbers);
		diagonalUpMax(numbers);
